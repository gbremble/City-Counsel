...
var queryURL = "https://api.openweathermap.org/data/2.5/forecast/daily?q=" + cityName + "," + stateName + "," + countryName + "&cnt=6&appid=" + APIKey;
    ...
    $.ajax({
      ...
      var timeU = response.list[0].dt
      var tempLowK = response.list[0].temp.min
      var tempHighK = response.list[0].temp.max
      ...
      iconImg = '<img src=' + iconURL + ' alt=' + conditionDescription + '>';
